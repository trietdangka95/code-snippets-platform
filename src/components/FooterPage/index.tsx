        ...
        <div className="grid grid-cols-1 md:grid-cols-8 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-2xl font-bold">CodeSnippets</h3>
                <p className="text-gray-300 text-sm">Developer Platform</p>
              </div>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Share, discover, and learn from the best code snippets. Join
              thousands of developers building amazing things together.
            </p>
