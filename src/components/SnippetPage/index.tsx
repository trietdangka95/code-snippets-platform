  ...
  const placeholderSnippets = [
    {
      ...
      code: "console.log('Binary Search Algorithm');",
      complexity: "O(log n)",
    },
  ];
      ...
      <div className="mb-8">
        <div className="relative">
          <div className="flex items-center gap-3 bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-xl px-4 py-3 shadow-lg hover:shadow-xl transition-all duration-200">
            ...
            />
            <Button className="px-3 py-1 bg-blue-100 text-blue-700 rounded-lg text-xs font-medium hover:bg-blue-200 transition-colors cursor-pointer">
              Filter
            </Button>
          </div>
        </div>
