            ...
            >
              ...
              <div className="flex sm:justify-end">
                <div className="flex w-full sm:w-auto flex-col sm:flex-row gap-2">
                  ...
                  <Button
                    type="button"
                    className="inline-flex items-center justify-center gap-1 px-3 py-2 sm:px-4 sm:py-2 bg-red-100 text-red-700 rounded-lg hover:bg-red-200 transition-colors text-sm font-medium w-full sm:w-auto"
